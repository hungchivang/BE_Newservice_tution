package onegroup.onekids_excel_v3.dto.filter;
...
public class FilterDTO {
    ...
    private String fullName; //thêm mới
    private String nickName;
    private String kidStatus; //thêm mới
    private String gradeName; //thêm mới
    private String className; //thêm mới
